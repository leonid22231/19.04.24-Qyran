...
import com.thedeveloper.qyran.util.StorageFileNotFoundException;
...
public class ImageService implements StorageService {
    ...
    public void store(MultipartFile file) {
        if (file.isEmpty()) {
            throw new FilesException("Failed to store empty file.");
        }
    ...
    public Stream<Path> loadAll() {
        try {
            ...
            throw new FilesException("Failed to read stored files", e);
        }
    }
