...
class _MainPageState extends State<MainPage>{
  ...
  double _bottomPadding(int index){
    switch(index){
      case 0: return 0;
      default: return widgetPadding;
    }
  }
  Widget _getPage(int index){
    switch(index){
      case 0: return const CoursePage();
      case 1: return NotificationListener<NotifyCourse>(
        onNotification: (m){
          pageIndex = 0;
          setState(() {
